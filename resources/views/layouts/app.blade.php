...
<body class="bg-white dark:bg-slate-900 transition-colors duration-200">
    <div class="flex min-h-screen">
        <aside class="hidden md:flex flex-col w-64 bg-slate-800 text-white p-6" id="aside">
            <div class="flex-1">
            ...
            <div class="mt-auto">
                <form action="{{ route('logout') }}" method="POST">
                    @csrf
                    <x-button class="w-full bg-red-600 hover:bg-red-700 border-none">
                        Logout
                    </x-button>
                </form>
            </div>
        ...
        <main class="flex-1 bg-slate-100 dark:bg-slate-900">
            <header class="bg-white dark:bg-slate-800 border-b dark:border-slate-700 px-6 py-4 flex justify-between">
